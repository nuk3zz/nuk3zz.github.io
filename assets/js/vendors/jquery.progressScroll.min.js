$.fn.progressScroll=function(e){
    var r = $.extend({ width: 50, height: 50, borderSize: 5, mainBgColor: "#222F43", lightBorderColor: "#1f1f1f", darkBorderColor: "#e7881c", fontSize: "20px" }, e);
    var t,
        i,
        n,
        o = this,
    ...
    this.updateProgress = function (e) {
        ...
        var r = (e * 360) / 100;
        if (r <= 180) {
            $("." + s, a).css("background-image", "linear-gradient(" + (90 + r) + "deg, transparent 50%, #1f1f1f 50%),linear-gradient(90deg, #1f1f1f 50%, transparent 50%)");
        } else {
            $("." + s, a).css("background-image", "linear-gradient(" + (r - 90) + "deg, transparent 50%, #e7881c 50%),linear-gradient(90deg, #1f1f1f 50%, transparent 50%)");
        }
        $("." + l, a).text();
    };
    //e+"%"
